...
public class Cloudlet {
	...
	//User implemented data type for deadline in milliseconds
	int cloudletDeadline;
	
	//User implemented data type to specify priority
	int cloudletPriority;
	...
	public Cloudlet(
			...
			final int cloudletDeadline,
			final int cloudletPriority,
			final int pesNumber,
	...
	public Cloudlet(
		...
		this.cloudletPriority = cloudletPriority;
	...
	public boolean setCloudletDeadline(final int cloudletDeadline) {
		if (cloudletDeadline <= 0) {
			return false;
		}
	...
	public int getCloudletDeadline() {
		return this.cloudletDeadline;
	}
	
	public int getCloudletPriority() {
		return this.cloudletPriority;
	}
