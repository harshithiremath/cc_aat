...
protected void submitCloudlets() {
        ...
        Collections.sort(tempList, new Comparator<Cloudlet>(){
             public int compare(Cloudlet c1, Cloudlet c2){
                 if(c1.cloudletDeadline == c2.cloudletDeadline)
                     return c1.cloudletPriority > c2.cloudletPriority ? -1 : 1;
                 return c1.cloudletDeadline < c2.cloudletDeadline ? -1 : 1;
             }
        });
        ...
        for(Cloudlet printCloudlet: tempList)
        {
            Log.printLine(count+".Cloudlet ID:"+printCloudlet.getCloudletId()+",Cloudlet Length:"+printCloudlet.getCloudletLength()+
                    ",Cloudlet Deadline:"+printCloudlet.getCloudletDeadline()+",Cloudlet Priority:"+printCloudlet.getCloudletPriority());
            count++;
        }
